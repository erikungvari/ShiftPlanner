                  ...
                  <React.Fragment key={day}>
                    ...
                    {HOURS.map((_, hourIndex) => {
                      ...
                      return (
                        <div
                          key={key}
                          className={`p-2 border cursor-pointer text-center ${selectedHours[key] ? "bg-blue-300" : ""
                            }`}
      ...
      <div>
        <div className="flex items-center justify-center h-screen bg-gray-100">
          <div className="flex space-x-36">
            <button className="h-[37rem] w-[27rem] bg-gray-200 rounded-3xl border-gray-300 border-4 text-gray-700 text-3xl font-semibold shadow-md 
                            hover:bg-gray-300 transition hover:translate-y-8 hover:shadow-2xl">
              Join a company
            </button>
            <button onClick={createCompany} className="h-[37rem] w-[27rem] bg-gray-200 rounded-3xl border-gray-300 border-4 text-gray-700 text-3xl font-semibold shadow-md 
                            hover:bg-gray-300 transition hover:translate-y-8 hover:shadow-2xl">
              Create a company
            </button>
          </div>
